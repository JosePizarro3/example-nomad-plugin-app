...
```
pip install dist/nomad-example-plugin-app-0.1.0
```
...
### License
Distributed under the terms of the `Apache Software License 2.0`_ license, "nomad-example-plugin-app" is free and open source software
